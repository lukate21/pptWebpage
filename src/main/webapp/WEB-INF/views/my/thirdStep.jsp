		...
		<div class="col-md-12" id="portfolio-list">
			...
			<ul class="cbp-rfgrid">
				...
				<li class="wow fadeInLeft animated animated" data-wow-offset="30"
					...
					<a href="${context }/my/analysis/result.do" class="more"><img
						src="${context }/resources/blur-1853262_1920.jpg" alt="project">
						<div class="project-info">
							<div class="project-details">
								<h5 class="white-text red-border-bottom">나만의 분석 만들기3</h5>
