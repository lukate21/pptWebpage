...
<script>
	...
	$('.anaCode').click(function(){
		...
		var opiDic = '<span style="cursor:pointer;"><i class="fa fa-question blue popover-info" data-placement="top" data-rel="popover" title="의사사전"'
						+' data-content="<ul><li>의사사전은 상승일, 하락일, 동결일에 출현한 단어들의 집합을 구합니다.</li><li>각 집합의 공통부분은 중립 단어이며 여집합은 상승사전, 하락사전, 동결 사전으로 나뉘어집니다.<br/>(𝑇_𝑝𝑜𝑠  : 상승일에만 출현한 단어, 𝑇_𝑛𝑒𝑔  : 하락일에만 출현한 단어, 𝑇_𝑒𝑞𝑢  : 동결일에만 출현한 단어)</li>"></i></span>';
		var proDic1 = '<span style="cursor:pointer;"><i class="fa fa-question blue popover-info" data-placement="top" data-rel="popover" title="확률사전1"'
						+' data-content="<ul><li>확률사전1의 단어들은 상승치, 하락치, 동결치를 가지고있습니다.<br/>( 𝑇 ∋𝐼_𝑠𝑐𝑜𝑟𝑒, 𝐷_𝑠𝑐𝑜𝑟𝑒, 𝐸_𝑠𝑐𝑜𝑟𝑒 )</li><li>상승치는 단어가 상승일에 출현한 일 수 / 단어가 총 출현한 일 수 로 구합니다.<br/>( 𝐼_𝑠𝑐𝑜𝑟𝑒= 𝑇𝐹_𝑖𝑛𝑐 / 𝑇𝐹_𝑡𝑜𝑡𝑎𝑙 )</li><li>하락치와 동결치도 동일하게 구합니다.</li>"></i></span>';
		var proDic2 = '<span style="cursor:pointer;"><i class="fa fa-question blue popover-info" data-placement="top" data-rel="popover" title="확률사전2"'
						+' data-content="<ul><li>확률사전2의 단어들은 상승치, 하락치, 동결치를 가지고있습니다.<br/>( 𝑇 ∋𝐼_𝑠𝑐𝑜𝑟𝑒, 𝐷_𝑠𝑐𝑜𝑟𝑒, 𝐸_𝑠𝑐𝑜𝑟𝑒 )</li><li>상승치는 단어가 상승일에 출현한 일 수 / 총 상승일 수 로 구합니다.<br/>( 𝐼_𝑠𝑐𝑜𝑟𝑒 = 𝑇𝐹_𝑖𝑛𝑐 / 𝐷𝐹_𝑖𝑛𝑐 )</li><li>하락치와 동결치도 동일하게 구합니다.</li>"></i></span>';
